...
def main():
    ...
    parser = ArgumentParser(description='Chainer example: Siamese-triplet w/BERT')
    ...
    parser.add_argument('--train_docs',      default='datasets/nfcorpus/train.docs',                    type=str, help='training document data file (.txt)')
    parser.add_argument('--train_queries',   default='datasets/nfcorpus/train.nontopic-titles.queries', type=str, help='training query data file (.txt)')
    parser.add_argument('--train_qrels',     default='datasets/nfcorpus/train.2-1-0.qrel',              type=str, help='training query relevance file (.qrel)')
    parser.add_argument('--test_docs',       default='datasets/nfcorpus/test.docs',                     type=str, help='testing document data file (.txt)')
    parser.add_argument('--test_queries',    default='datasets/nfcorpus/test.nontopic-titles.queries',  type=str, help='testing query data file (.txt)')
    parser.add_argument('--test_qrels',      default='datasets/nfcorpus/test.2-1-0.qrel',               type=str, help='testing query relevance file (.qrel)')
