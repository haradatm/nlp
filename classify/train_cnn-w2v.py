...
class MyCNN(Chain):
    def __init__(self, input_channel, output_channel, height, width, n_label):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output',    '-o', default='model-cnn-w2v',  type=str, help='output directory')
    ...
    # Prepare CNN
    model = MyCNN(input_channel, output_channel, height, width, n_label)
