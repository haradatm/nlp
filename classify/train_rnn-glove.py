...
"""Chainer example: LSTM Neural Networks for Sentence Classification with GloVe pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: LSTM Classifier w/GloVe')
    ...
    parser.add_argument('--out',       '-o', default='model-rnn-embed',  type=str, help='output directory')
