...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: Bi-LSTM Classifier')
    ...
    parser.add_argument('--out',       '-o', default='model-rnn_b-embed-py3',  type=str, help='output directory')
