...
"""Chainer example: Convolutional Neural Networks for Sentence Classification with GloVe pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: CNN Classifier w/GloVe')
    ...
    parser.add_argument('--out',       '-o', default='model-cnn-embed',  type=str, help='output directory')
