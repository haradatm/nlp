...
"""Chainer example: bi-LSTM Neural Networks for Sentence Classification plus Self-Attention Mechanism with GloVe pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: bi-LSTM+Attention Classifier w/GloVe')
    ...
    parser.add_argument('--out',       '-o', default='model-rnn_ba-embed',  type=str, help='output directory')
