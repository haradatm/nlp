...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: LSTM+Attention Classifier')
    ...
    parser.add_argument('--out',       '-o', default='model-rnn_a-embed-py3',  type=str, help='output directory')
