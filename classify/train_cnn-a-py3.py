...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: CNN+Attention Classifier')
    ...
    parser.add_argument('--out',       '-o', default='model-cnn_a-embed-py3',  type=str, help='output directory')
    ...
    # Setup model
    model = CNNClassifier(n_layers=1, n_vocab=n_vocab, n_units=n_units, dropout=0.4, n_class=n_class)
    if args.gpu >= 0:
        model.to_gpu()
