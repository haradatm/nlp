...
"""Chainer example: bi-LSTM Neural Networks for Sentence Classification with BERT pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: bi-LSTM Classifier w/BERT')
    ...
    parser.add_argument('--out',       '-o', default='model-rnn-b-bert',  type=str, help='output directory')
