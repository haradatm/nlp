...
"""Chainer example: bi-LSTM Neural Networks for Sentence Classification plus Self-Attention Mechanism with BERT pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Chainer example: bi-LSTM+Attention Classifier w/BERT')
    ...
    parser.add_argument('--out',       '-o',  default='model-rnn-ba-bert',  type=str, help='output directory')
