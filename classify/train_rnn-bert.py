...
"""Chainer example: LSTM Neural Networks for Sentence Classification with BERT pre-trained embedding.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out',       '-o', default='model-rnn-bert',  type=str, help='output directory')
