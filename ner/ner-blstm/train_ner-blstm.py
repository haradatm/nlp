...
class BLSTM_CRF(chainer.Chain):
    ...
    def __init__(self, word_vocab_size, word_emb_size, word_lstm_units, num_tags):
        ...
        with self.init_scope():
            ...
            self.lstm = L.NStepBiLSTM(1, word_emb_size, word_lstm_units // 2, 0.5)
...
def main():
    ...
    parser.add_argument('--out', default='result-blstm', help='Directory to output the result')
    ...
    model = BLSTM_CRF(word_vocab_size, word_emb_size, word_lstm_units, num_tags)
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        for x_words_batch, x_chars_batch, t_batch in train_iter:
            ...
            # 順伝播させて誤差と精度を算出
            loss = model(x_words_batch, t_batch)
